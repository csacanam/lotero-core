...
Sends a POST **with** x402 payment (0.1 USDC). Claims earnings for a user (gasless).
...
**Environment variables:** same as spin-paid (payer needs 0.1+ USDC on Base for claim).
